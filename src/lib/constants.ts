...
import BuildifyCategory from '@/components/icons/buildify-category'
...
export const pricingCards = [
    ...
    },
    {
      ...
      priceId: '',  //this id should be inserted using stripe 
    },
    {
      title: 'Basic',
  ...
  export const addOnProducts = [
    {title : 'Priority Support' , id: 'prod_PBsndlnVnnshgV'}
  ]
