...
export const saveActivityLogNotification =  async ({
    ...
    if(!foundAgencyId){
        if(!subaccountId){
            throw new Error("You need to provide atleast an Agency Id or Sub account Id")
        }
...
export const updateAgnecyDetails = async (agnecyId:string,agencyDetails:Partial<Agency>) => {
